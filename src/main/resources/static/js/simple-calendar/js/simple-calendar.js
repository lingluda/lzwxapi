...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
		  key : "getCurrYear",
		  value: function getCurrYear(){
			  return $('#sc-select-curr-year').val();
		  }
	  },{
		 key : "getCurrMonth",
		 value:function getCurrMonth(){
			  return $('#sc-select-curr-month').val();
		  }
	  },{
    key: 'optionAssign',
    ...
    value: function create() {
      ...
      //actions
      header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '<div class="sc-yleft" title="上一年">' + ' &lsaquo;</div>' + ' <select class="sc-select-year" name="" style="margin-bottom:2px;">' + '</select>' + ' <div class="sc-yright" title="下一年">&rsaquo;</div>' + '</div>';
      header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '<div class="sc-mleft" title="上个月">' + ' &lsaquo;</div>' + ' <select class="sc-select-month" name="" style="margin-bottom:2px;">' + '</select>'+ ' <div class="sc-mright" title="下个月" style="margin-left:-11px;">&rsaquo;</div>' + '</div>';
      ...
      header.innerHTML = header.innerHTML + '<input type="hidden" id="sc-select-curr-year"><input type="hidden" id="sc-select-curr-month">';
    ...
    value: function update() {
      ...
      $('#sc-select-curr-year').val(year);
      $('#sc-select-curr-month').val(month);
    }
    ...
    value: function updateEvent() {
      ...
      yearadd.onclick = function () {
        ...
        $('#sc-select-curr-year').val(currentyear);
        if(this.tmonth){
       	  $('#sc-select-curr-month').val(this.tmonth);
       }
      ...
      monthadd.onclick = function () {
        ...
        $('#sc-select-curr-year').val(currentyear);
        $('#sc-select-curr-month').val(currentmonth);
